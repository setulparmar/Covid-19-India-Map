...
link = 'https://github.com/setulparmar/Covid-19-India-Map'

app.layout=html.Div(style={'backgroundColor':'#111111'},children=[html.H1('Covid19-India-Map(By- Setul Parmar)',
                                                                          style={'color':'#FBABAB'}),
                                                                  html.H5('These numbers are only shown state wise and not district wise.',
                                                                          style={'color':'#7FDBFF'}),
